...
## **PART II - ROAD RACES Rules amendments applying on 06.02.2026** 

**Chapter II GENERAL PROVISIONS** _(numbering of the articles modified on 1.01.05)._ 
...
- secondary classifications including all the information required (points, tie-break procedures, etc.); 
...
- A visual representation of the signage used on the  course, 
   ...
   - including directional arrows and signs indicating narrowing roads, roundabouts, level crossings, specific points, etc.); 
...
- the event’s safety organisation chart, providing details of the identity, functions and contact details of those in charge of  the 
...
||**2026 and subsequent**|
|**Events in Europe**||
|Minimum number of UCI<br>WorldTeams and UCI ProTeams<br>at the start for the relevant year<br>|13|
...
relevant year **Events outside Europe** Minimum number of UCI WorldTeams and UCI ProTeams 10 at the start for the relevant year Minimum number of UCI WorldTeams at the start for the 3 relevant year Minimum number of UCI ProTeams at the start for the 5 relevant year 
